...
{
    /// <summary>
    /// Displays the hex-formatted Steam ID of the tracked user in a TMP input field.
    /// </summary>
    ...
    {
        /// <summary>
        /// The TextMeshPro input field to display the user's hex ID in.
        /// </summary>
        ...
        private void Awake()
        {
            ...
            if (_mSteamUserData.Data.IsValid && input != null)
        ...
        private void HandlePersonaStateChanged(UserData user, EPersonaChange flag)
        {
            ...
            input.text = _mSteamUserData.Data.IsValid ? _mSteamUserData.Data.HexId : string.Empty;
        }
    }
}
#endif
